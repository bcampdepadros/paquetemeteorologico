...
This outlines how to propose a change to paquetemeteorologico. For a
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("bcampdepadros/paquetemeteorologico", fork = TRUE)`.
...
[Contributor Code of
Conduct](https://bcampdepadros.github.io/paquetemeteorologico/CODE_OF_CONDUCT.md).
